...
const DocumentForm = (props: DocumentFormProps) => {
  ...
  const [author, setAuthor] = useState(props.document ? props.document.author : 'Authored By');
  const [steps, setSteps] = useState<Step[]>(props.document ? props.document.steps : []);
